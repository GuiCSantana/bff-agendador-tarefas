...
public class CronService {
    ...
    public void buscaTarefasProximaHora() {
        ...
        LocalDateTime horaFutura = LocalDateTime.now().plusHours(1); //LocalDateTime.now (hora atual)
        LocalDateTime horaFuturaMaisCinco = LocalDateTime.now().plusHours(1).plusMinutes(5);

        List<TarefasDTOResponse> listaTarefas = tarefasService.buscaTarefasAngendadasPorPeriodo(horaFutura,
