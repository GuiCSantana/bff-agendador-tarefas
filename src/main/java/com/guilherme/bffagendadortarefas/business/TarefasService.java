...
import com.guilherme.bffagendadortarefas.infrastrucutre.client.TarefasClient;
...
public class TarefasService {
    ...
    public List<TarefasDTOResponse> buscaTarefasAngendadasPorPeriodo(LocalDateTime dataInicial,
